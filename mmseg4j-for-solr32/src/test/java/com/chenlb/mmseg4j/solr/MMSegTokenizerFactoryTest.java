...
public class MMSegTokenizerFactoryTest extends AbstractSolrTestCase {
	...
	public String getSolrHome() {
		return SolrTestCaseJ4.getFile("solr/collection1").getPath();
	}
	...
	public static void beforeClass() throws Exception {
		initCore("solrconfig.xml", "schema.xml", getFile("solr/collection1").getParent(), "collection1");
	}
	*/

	private Dictionary getDictionaryByFieldType(String fieldTypeName) {
    FieldType ft = h.getCore().getSchema().getFieldTypeByName(fieldTypeName);
